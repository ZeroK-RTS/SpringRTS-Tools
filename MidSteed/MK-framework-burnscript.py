...
#SayPrivate('koshi',"0.41 screwed my SL, this is a bot only, what do I do to get SL back? (last working version was .35)")
Join('sy')
Say('sy',"I need the URL/IP for spring IRC - SL .41 screwed my SL")

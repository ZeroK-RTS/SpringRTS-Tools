...
spring = SpringCallback().login('WhereWantsIt', Hash("1243540")) #a very important line. This handles login and (I think) lets us use many of springlib's functions
...
spring.Send('RENAMEACCOUNT MidDay')
#------------------...and here.
spring.pump()

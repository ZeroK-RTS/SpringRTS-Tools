...
spring = SpringCallback().login('MessageBot', SpringCallback().Hash("1243540")) #a very important line. This handles login and (I think) lets us use many of springlib's functions
